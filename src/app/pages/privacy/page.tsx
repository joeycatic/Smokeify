...
export default function Datenschutz() {
  return (
    <InfoPageShell
      ...
      description="Informationen zur Verarbeitung personenbezogener Daten, zu Hosting, Zahlungsdienstleistern, Cookies und deinen Rechten."
      meta="Stand: 01.02.2026"
    >
      <InfoSections sections={DATENSCHUTZ_SECTIONS} />
    </InfoPageShell>
  );
}
