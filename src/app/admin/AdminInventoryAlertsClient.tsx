        ...
        <>
          <div className="admin-mobile-card-list md:hidden">
            {variants.map((variant) => (
              <div key={variant.id} className="admin-mobile-card">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 text-sm text-slate-400">{variant.title}</div>
                  </div>
                  <span
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <CardMeta label="Threshold" value={String(variant.threshold)} />
                  <CardMeta
                    label="Cover"
                    value={
                  ...
                  />
                  <CardMeta label="On hand" value={String(variant.onHand)} />
                  <CardMeta
                    label="Updated"
                    value={new Date(variant.updatedAt).toLocaleDateString("de-DE")}
                  />
                </div>
              </div>
            ))}
          ...
          <div className="admin-data-grid-scroll hidden rounded-[24px] border border-white/10 bg-[#070a0f] md:block">
