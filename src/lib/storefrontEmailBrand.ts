...
const BRAND_META: Record<StorefrontCode, StorefrontEmailBrandMeta> = {
  MAIN: {
    ...
    heroMutedTextColor: "rgba(246,240,232,0.88)",
    cardBackgroundColor: "#181512",
    cardBorderColor: "rgba(255,240,220,0.14)",
    panelBackgroundColor: "#231d18",
    panelBorderColor: "rgba(255,240,220,0.16)",
    noticeBackgroundColor: "#2a211b",
    noticeBorderColor: "#f1c684",
    textColor: "#f6f0e8",
    mutedTextColor: "#d9c6b2",
    subtleTextColor: "#bea58d",
    footerTextColor: "#c3af9a",
    footerMutedTextColor: "#9d8976",
