...
export const ADMIN_SCRIPT_DEFINITIONS: readonly AdminScriptDefinition[] = [
  ...
  },
  {
    ...
    outputSummary:
      "Stores the latest Bloomtech preview payload in persistent admin storage for later review or import.",
    impact: "Refreshes the stored Bloomtech preview payload only.",
  ...
  },
  {
    ...
    outputSummary:
      "Stores the latest Bloomtech preview payload in persistent admin storage, containing the single scraped product.",
    impact: "Refreshes the stored Bloomtech preview payload only.",
  ...
  },
  {
    ...
    category: "Suppliers",
    description:
      "Read the latest stored Bloomtech preview payload and prepare product create or update actions for Bloomtech-linked catalog records.",
    inputSummary:
      "Consumes the latest persisted Bloomtech preview generated by the Bloomtech scrape preview.",
    outputSummary:
